...
| API-09 | API | AC-07 | Admin user list/search/filter/create/edit/reset. | Hash never returned; reset sets required change. | `server/tests/lab-03/users-admin.api.test.ts` | Pass |
...
| UI-05 | UI component | AC-07 | User list/Create/Edit/deactivation dialogs, combined search/role filters and all list states. | Form errors and safety feedback are accessible; filters combine and clear. | `client/tests/lab-03/UserManagement.test.tsx` | Pass |
...
| E2E-03 | E2E | AC-07–08 | Admin creates/edits/resets User; role deep links and direct API restrictions. | Admin guards hold; newly provisioned User must change password. | `e2e/lab-03/user-administration.spec.ts` | Pass |
...
| AC-07 | UNIT-05, API-09/10, UI-05, E2E-03 | Pass |
...
| User administration | AC-07, AC-08 | UNIT-05, API-09/10, UI-05, E2E-03 |
