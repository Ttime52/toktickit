...
ต้องเขียนให้ชัดเจน และละเอียดว่าจะให้ AI ทำอะไร ตาม criteria ถ้าไม่เขียนให้ละเอียด AI จะทำการเดาแล้วเจนออกมาไม่ตรงตามที่เราต้องการ การระบุไฟล์ที่จะให้แก้ชัดเจน จะช่วยให้ AI ทำงานดีขึ้น